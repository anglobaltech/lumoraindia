        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-10">
                ...
                <div key={review.id} className="bg-white border border-gray-100 shadow-sm hover:shadow-md transition-shadow rounded-2xl p-5 md:p-6">
                  <div className="flex flex-wrap items-center justify-between gap-3 mb-3">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 bg-gradient-to-br from-pink-100 to-pink-200 rounded-full flex items-center justify-center text-pink-700 font-black shadow-inner">
                        {review.userName ? review.userName.charAt(0).toUpperCase() : "U"}
                      </div>
                      <div>
                        <h4 className="font-extrabold text-gray-900 text-base">{review.userName || "User"}</h4>
                        <div className="flex items-center gap-2 mt-0.5">
                          <div className="flex">{renderStars(review.rating)}</div>
                          <span className="text-[10px] text-gray-400 font-bold">• {new Date(review.createdAt).toLocaleDateString('en-IN', { day: 'numeric', month: 'short', year: 'numeric' })}</span>
                        </div>
                      </div>
                    </div>
                    <span className="flex items-center gap-1 text-[10px] font-black tracking-widest uppercase text-emerald-600 bg-emerald-50 px-2.5 py-1 rounded-full border border-emerald-100">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white shadow-xl shadow-gray-100/50 p-6 rounded-[1.5rem] border border-gray-100 sticky top-24">
              <h3 className="text-xl font-extrabold text-gray-900 mb-5 flex items-center gap-2">Write a Review</h3>
              ...
              {!user ? (
                ...
                <form onSubmit={handleReviewSubmit} className="space-y-5">
                  <div className="bg-gray-50 p-3 rounded-xl border border-gray-100">
                    <label className="block text-xs font-bold text-gray-900 mb-2">Rate your experience</label>
                  ...
                  <div>
                    <label className="block text-xs font-bold text-gray-900 mb-1.5">Your Review</label>
                    <textarea
                      required
                      value={newReviewText}
                  ...
                  <button
                    ...
                    className="w-full py-3 bg-gradient-to-r from-pink-600 to-pink-500 text-white rounded-xl font-black text-sm hover:shadow-md hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2 disabled:opacity-50 cursor-pointer"
                  >
        ...
        <div className="fixed inset-0 bg-gray-900/40 z-[100] flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-white rounded-[1.5rem] p-6 max-w-sm w-full shadow-2xl relative animate-in zoom-in-95 duration-200">
            <button
              ...
              className="absolute top-4 right-4 w-8 h-8 flex items-center justify-center bg-gray-100 rounded-full text-gray-600 hover:bg-pink-100 hover:text-pink-600 transition-colors cursor-pointer font-bold"
            >
              ✕
            </button>
            <h3 className="text-xl font-extrabold text-gray-900 mb-5 flex items-center gap-2.5">
            ...
            <div className="overflow-hidden rounded-xl border border-gray-200 shadow-sm">
              <table className="w-full text-left border-collapse text-sm">
                <thead>
                  <tr className="bg-gray-50 text-gray-900 text-xs uppercase tracking-wider font-black">
                ...
                <tbody className="text-gray-600 font-medium">
                  <tr className="border-b border-gray-100 hover:bg-pink-50/50 transition-colors">
                    <td className="p-3 font-black text-gray-900 border-r border-gray-100">M</td>
                  ...
                  <tr className="border-b border-gray-100 bg-gray-50/30 hover:bg-pink-50/50 transition-colors">
                    <td className="p-3 font-black text-gray-900 border-r border-gray-100">L</td>
                    <td className="p-3 border-r border-gray-100">280 mm</td>
                    <td className="p-3">11.0"</td>
                  </tr>
                  <tr className="border-b border-gray-100 hover:bg-pink-50/50 transition-colors">
                    <td className="p-3 font-black text-gray-900 border-r border-gray-100">XL</td>
                  ...
                  <tr className="hover:bg-pink-50/50 transition-colors">
                    <td className="p-3 font-black text-gray-900 border-r border-gray-100">XXL</td>
