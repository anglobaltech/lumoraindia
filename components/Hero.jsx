...
const Hero = () => {
  ...
  return (
    <div className="bg-white text-gray-700">
      {/* 1. TOP HERO SECTION */}
      <section className="bg-gradient-to-br min-h-screen from-pink-100 via-white to-pink-50 w-full p-12 relative overflow-hidden">
        <div className="w-full max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 xl:px-20 grid lg:grid-cols-2 gap-10 lg:gap-16 relative z-10">
          ...
          <div className="space-y-4 sm:space-y-5 w-full relative z-10">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white shadow-sm border border-pink-100 text-pink-600 text-[10px] sm:text-xs font-semibold w-fit animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex flex-wrap gap-3 sm:gap-4 pt-3">
              <Link href="/products" className="bg-pink-600 text-white px-6 sm:px-8 py-2.5 rounded-2xl text-sm sm:text-base font-semibold shadow-md shadow-pink-200 hover:bg-pink-700 hover:scale-105 transition-all cursor-pointer">
                Shop Now
              </Link>
              <Link href="/about-us" className="bg-white text-gray-700 border border-gray-200 px-6 sm:px-8 py-2.5 rounded-2xl text-sm sm:text-base font-semibold hover:bg-gray-50 hover:border-gray-300 hover:scale-105 transition-all cursor-pointer shadow-sm">
                Learn More
              </Link>
            </div>
            ...
            <div className="flex flex-wrap gap-6 sm:gap-10 xl:gap-12 pt-6 border-t border-gray-100 mt-6">
              {[
                ...
                <div key={i} className="group cursor-default">
                  <h3 className="text-lg sm:text-xl xl:text-2xl font-semibold text-gray-700 group-hover:text-pink-600 transition-colors">
                    {stat.value}
                  </h3>
            ...
            <div className="relative w-full max-w-[320px] sm:max-w-md lg:max-w-lg xl:max-w-[500px] h-[280px] sm:h-[360px] lg:h-[400px] xl:h-[440px]">
              ...
              <div onClick={scrollToReviews} className="absolute -bottom-6 sm:-bottom-8 left-1/2 transform -translate-x-1/2 bg-white p-2.5 sm:p-3 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] z-20 flex items-center gap-3 border border-gray-100 w-max cursor-pointer hover:-translate-y-1 transition-all duration-300 animate-in fade-in slide-in-from-bottom-8 delay-300">
                <div className="flex -space-x-2 shrink-0">
                  <div className="w-8 h-8 rounded-full border-2 border-white bg-pink-100 flex items-center justify-center text-pink-600 font-semibold text-xs">P</div>
                  <div className="w-8 h-8 rounded-full border-2 border-white bg-blue-100 flex items-center justify-center text-blue-600 font-semibold text-xs">A</div>
                  <div className="w-8 h-8 rounded-full border-2 border-white bg-green-100 flex items-center justify-center text-green-600 font-semibold text-xs">S</div>
                </div>
                <div>
                  <p className="text-[11px] sm:text-xs font-semibold text-gray-700 whitespace-nowrap">Loved by Thousands</p>
