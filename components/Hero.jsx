...
const Hero = () => {
  ...
  return (
    <div className="bg-white text-gray-700">
          ...
          <div className="space-y-5 sm:space-y-6 w-full relative z-10 flex flex-col justify-center">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 pt-3">
              <Link href="/contact-us" className="w-full sm:w-auto">
                <button className="w-full sm:w-auto px-6 py-3 bg-pink-500 text-white rounded-2xl text-sm sm:text-base font-semibold shadow-md shadow-pink-200 border-2 border-transparent hover:bg-pink-600 hover:scale-105 transition-all cursor-pointer flex justify-center items-center">
                  Contact For Order
                </button>
              </Link>
              <Link href="/products" className="w-full sm:w-auto">
                <button className="w-full sm:w-auto px-6 py-3 bg-white text-gray-700 border-2 border-gray-200 rounded-2xl text-sm sm:text-base font-semibold hover:bg-gray-50 hover:border-gray-300 hover:scale-105 transition-all cursor-pointer shadow-sm flex justify-center items-center">
                  View Products
                </button>
              </Link>
              <Link href="/about-us" className="w-full sm:w-auto">
                <button className="w-full sm:w-auto px-6 py-3 bg-pink-50 text-pink-600 border-2 border-pink-200 rounded-2xl text-sm sm:text-base font-semibold hover:bg-pink-100 hover:border-pink-300 hover:scale-105 transition-all cursor-pointer shadow-sm flex justify-center items-center">
                  Learn More
                </button>
              </Link>
            </div>
            ...
            <div className="w-full lg:w-1/2 p-8 sm:p-10 flex flex-col space-y-6 justify-center">
                ...
                <div className="flex flex-wrap gap-3">
                  {[1, 3, 5, 7].map((pack) => (
                    <button
                      ...
                      className={`px-4 py-2 rounded-xl border-2 font-semibold transition-all cursor-pointer ${selectedPack === pack ? "border-pink-600 bg-pink-600 text-white shadow-md shadow-pink-200" : "border-gray-200 text-gray-600 bg-white hover:border-pink-300 hover:bg-pink-50"}`}
                    >
                      {pack} Pack
                    </button>
                  ))}
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4 border-t border-gray-100">
                {quantityInCart > 0 ? (
                  ...
                  <button onClick={handleAddToCart} className="flex-1 py-2 rounded-xl font-semibold text-lg flex items-center justify-center gap-2 bg-gray-700 text-white hover:bg-gray-800 transition-all duration-300 shadow-md cursor-pointer">
                    <ShoppingCart size={20} /> Add to Cart
                  </button>
                )}
                <button onClick={handleBuyNow} className="flex-1 py-2 rounded-xl font-semibold text-lg flex items-center justify-center gap-2 bg-gradient-to-r from-pink-600 to-pink-500 text-white shadow-md shadow-pink-200 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer">
      ...
      {/* 8. CTA SECTION */}
      <section className="py-20 text-center bg-pink-50 font-semibold">
        <h2 className="text-2xl md:text-3xl font-semibold mb-6" data-aos="fade-up">Ready for Better Comfort?</h2>
        <p className="text-gray-600 mb-8 max-w-xl mx-auto text-lg" data-aos="fade-up" data-aos-delay="100">
        ...
        <Link href="/products" data-aos="zoom-in" data-aos-delay="200">
          <button className="bg-pink-600 text-white px-6 py-2 rounded-2xl font-semibold text-lg shadow-lg hover:bg-pink-700 hover:scale-105 transition-all cursor-pointer">
            Buy Now
          </button>
        </Link>
      </section>
