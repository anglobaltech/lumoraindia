    ...
    <div className="bg-white text-gray-800">
      ...
      hover:shadow-2xl hover:-translate-y-2 transition duration-500 group"
            >
              ...
              {/* Bestseller Badge */}
              <div
                className="absolute -top-4 -left-4 bg-pink-500 text-white text-xs px-4 py-1 rounded-full shadow
        ...
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 w-full">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-base md:text-lg">
              Discover Lumora's premium range of sanitary napkins designed to
              provide maximum comfort, protection, and hygiene during every
              stage of your day.
            </p>
          </div>
